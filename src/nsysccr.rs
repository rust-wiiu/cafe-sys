...
imports_section!(
    ...
    [
        ...
        "CCRCDCRegisterAttachCallback",
        "CCRCDCRegisterCFGAttachCallback",
        "CCRCDCRegisterDrhAttachCallbackForAvm",
        ...
        "CCRCFGSetMessageLEDMode",
        "CCRCFGSetRemoteInfo",
        "CCRCFGSetRumbleMode",
        "CCRCFGSetVersionCheckFlag",
        "CCRDisableFwUpdateMode",
        "CCREnableDrhCheck",
        "CCREnableFwUpdateMode",
        "CCREnablePowerButton",
        "CCRHIDGetAccelerometer",
        "CCRHIDGetAnalogStick",
        "CCRHIDGetBatteryInfo",
        "CCRHIDGetBufferedData",
        "CCRHIDGetData",
        "CCRHIDGetDigitalButton",
        "CCRHIDGetFirmwareVersion",
        "CCRHIDGetGyroscope",
        "CCRHIDGetIndicator",
        "CCRHIDGetMagnet",
        "CCRHIDGetRegisteredList",
        "CCRHIDGetSequence",
        "CCRHIDGetTouchPanel",
        "CCRHIDGetVolumeSlider",
        "CCRHIDSetRegisteredCallback",
        "CCRHIDSetup",
        "CCRHIDStart",
        "CCRHIDStop",
        "CCRHIDTeardown",
