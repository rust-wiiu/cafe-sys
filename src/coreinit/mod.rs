...
/// Generic Queue
///
/// Most queues share a memory layout (in coreinit).
#[repr(C)]
#[derive(Clone)]
pub struct Queue<T> {
    pub head: *mut T,
    pub tail: *mut T,
    pub parent: *mut ffi::c_void,
...
/// Generic Link
///
/// Most links share a memory layout (in coreinit).
#[repr(C)]
#[derive(Clone)]
pub struct Link<T> {
    pub next: *mut T,
...
imports_section!(
    ...
    [
        ...
        "OSGetMemBound",
        "OSGetOSID",
        "OSGetOverlayArenaRange",
        "OSGetOverlayArenaRangeDev",
        "OSGetPFID",
